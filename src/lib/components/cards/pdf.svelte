...
<script lang="ts">
	...
	const formspreeEndpoint = 'https://formspree.io/f/mpqeewbq';
...
>
	...
	<div class="mt-5 flex flex-wrap gap-3">
		...
		<a bind:this={downloadLink} href={resource.file} download class="hidden" aria-hidden="true">
...
{#if isFormOpen}
	...
	>
		...
		<div
			class="relative w-full max-w-lg rounded-lg border border-ocean-blue/10 bg-white p-6 shadow-xl"
			role="dialog"
			aria-modal="true"
